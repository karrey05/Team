...
ct_t=read_dict['cloudcount_t']
#cloudcount_t=read_dict['cloudcount_t']
...
#plt.plot(x, cloudcount_t,lw=2.5,color=color_sq[0])
...
#plt.text(20, 30,'cloudcount', fontsize=14, fontweight='bold',color=color_sq[0])
...
figure=plt.gcf()
outname='./city_cloud_count_'+str(dbox)+'.png'
